...
# Created by Armaan singh bhau (Armaan42)
...
echo "This tool is created by Armaan singh bhau (Armaan42)."

echo ""

echo "Disclaimer"
echo "1. This tool is provided for educational purposes only. It should not be used for illegal activities."
echo "2. Use this tool at your own risk and with proper authorization. Ensure compliance with applicable laws and obtain necessary permissions before using it."
